...
public class Item_registry {
    ...
    public static final RegistryObject<Item> SEIMEI = ITEMS.register("seimei",
            () -> new some_buffItem(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> LOOT_BACK = ITEMS.register("lootback",
            () -> new lootback(new Item.Properties().stacksTo(1)));
}